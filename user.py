...
\033[1;94mLoveHackerSoHag\033[1;91m: \033[1;91▒▓██████████████]99.9
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:love_HackerSoHag
	    time.sleep(2)
            loop = 'false'
        else:
...
def login():
	...
	try:
		...
		print "\033[1;95m♡──────────•◈•──────────♡\033[1;96m N S SoHag Chowdhury\033[1;95m♡──────────•◈•──────────♡"
...
def menu():
	...
	try:
		...
		keluar()
	os.system("clear") #Dev:love_HackerSoHag
	print logo
...
def pilih_super():
	...
	print "  \033[1;93m«---•◈•---Developed By love---•◈•---»" #Dev:love_HackerSoHag
	...
	print """
             ...
             ◥⊙▲⊙▲⊙▲⊙▲⊙▲⊙◤
♡──────────────•◈•──────────────♡.
: \033[1;96m .....loveHackerSoHag  N S SoHag Chowdhury........... \033[1;93m :
♡──────────────•◈•──────────────♡.' 
                whatsapp Num
               +8801755974285"""
